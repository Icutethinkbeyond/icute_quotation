    ...
    const pages = useMemo(() => {
      ...
      for (let i = 0; i < allContentRows.length; i++) {
        ...
        if (row.type === "header") {
          ...
          if (i + 1 < allContentRows.length && allContentRows[i + 1].type === "item_name") {
            rowsToAdd += 2; // Add space for item_name + item_details
          } else if (i + 1 < allContentRows.length && allContentRows[i + 1].type === "subtotal") {
        ...
        if (row.type === "item_name") {
            ...
            if (i + 1 < allContentRows.length && allContentRows[i + 1].type === "item_details") {
        ...
        if (row.type === "header" && rowsToAdd === 1 && currentPageRows.length > 0 && currentPageRows[currentPageRows.length - 1].type === "header") {
